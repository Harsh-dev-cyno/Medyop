  ...
  return (
    <ScrollView style={{marginVertical:5}}>
      ...
      <View style={styles.CoverBtn}>
        <TouchableOpacity style={styles.AddBtn}><Text style={styles.btnText}>Delet It</Text></TouchableOpacity>
        <TouchableOpacity style={styles.MainAddBtn}><Text style={styles.btnText}>Add More</Text><AntDesign name="pluscircleo" size={24} color={color.colors.gray} /></TouchableOpacity>
        <TouchableOpacity style={styles.AddBtn}><Text style={styles.btnText}>Submit</Text></TouchableOpacity>
      </View>
    </ScrollView>
  );
};
